    ...
    with st.spinner("Analyzing match control..."):
        ...
        with tab7:
            ...
            try:
                ...
                ax_home_bars_imp.set_position([pos_left.x0, pos_left.y0 + 0.035, pos_left.width, pos_left.height])
                pos_right = ax_away_bars_imp.get_position()
                ax_away_bars_imp.set_position([pos_right.x0, pos_right.y0 + 0.035, pos_right.width, pos_right.height])
            except Exception:
                pass
            ...
            title_y = ymin_data + height * 0.062
